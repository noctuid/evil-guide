...
This has been a known problem for a while (see [[https://bitbucket.org/lyro/evil/issues/130/evil-define-key-can-no-longer-bind-key-in][issue 130]] and especially [[https://bitbucket.org/lyro/evil/issues/301/evil-define-key-for-minor-mode-does-not][issue 301]], which explains some of the issues with ~evil-define-key~). This doesn't happen for most modes, but when it does happen, it's annoying.
